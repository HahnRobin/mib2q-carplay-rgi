...
> [[rgd-tlv]] - 0x5204 -> **lane-guidance** - shared gate -> [[bap-fctids]] FctID 24 +
> [[maneuver-renderer]] lane panel
...
`route_generation` change clears it ([[rgd-activation]]).
...
area** ([[maneuver-renderer]]), transparent background:
