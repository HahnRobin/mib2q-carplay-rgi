/*
 * Test harness for maneuver_render — standalone GLFW binary (macOS only).
 *
 ...
 *   2. Run maneuver_render (connects to 127.0.0.1:CR_TCP_PORT).
...
int main(int argc, char **argv) {
    ...
    GLFWwindow *window = glfwCreateWindow(320, 100, "maneuver_render harness", NULL, NULL);
    if (!window) {
